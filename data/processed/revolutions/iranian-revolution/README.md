...
Countries whose political order was at stake: Iran.

## The cohort

2,432 elites, of whom 1,235 (51%) span two sectors. Birth years 1888 to 1959; median age when the window opened, 34. Death year is imputed as birth plus 80 for 62% of them, for the alive test only.
...
| Group | Share |
|---|---:|
| Learning & Culture | 61.1% |
| Politics | 29.1% |
| Business | 9.0% |
| Religion | 7.0% |
| Administration & Law | 5.6% |
| Military | 4.5% |
| Nobility & Kinship | 3.9% |
...
| `birth_cohort_pairs.csv` | the same countries by 40-year birth cohort, 1880 to 1999, as context either side of the window |
